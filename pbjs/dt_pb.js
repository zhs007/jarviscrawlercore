 ...
 * @return {!proto.jarviscrawlercore.DTGameResultErr} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.jarviscrawlercore.RequestDTData} returns this
 */
...
proto.jarviscrawlercore.DTBusinessGameReport.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    totalwin: jspb.Message.getFloatingPointFieldWithDefault(msg, 3, 0.0),
    totalbet: jspb.Message.getFloatingPointFieldWithDefault(msg, 4, 0.0),
...
/**
 * @param {string} value
 * @return {!proto.jarviscrawlercore.DTBusinessGameReport} returns this
 */
...
proto.jarviscrawlercore.DTTodayGameData.toObject = function(includeInstance, msg) {
  var f, obj = {
    totalwin: jspb.Message.getFloatingPointFieldWithDefault(msg, 1, 0.0),
    totalbet: jspb.Message.getFloatingPointFieldWithDefault(msg, 2, 0.0),
...
/**
 * @param {number} value
 * @return {!proto.jarviscrawlercore.DTTodayGameData} returns this
 */
...
proto.jarviscrawlercore.DTGPKGameResult.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    win: jspb.Message.getFloatingPointFieldWithDefault(msg, 5, 0.0),
    bet: jspb.Message.getFloatingPointFieldWithDefault(msg, 6, 0.0),
    off: jspb.Message.getFloatingPointFieldWithDefault(msg, 7, 0.0),
    lines: jspb.Message.getFieldWithDefault(msg, 8, 0),
    moneystart: jspb.Message.getFloatingPointFieldWithDefault(msg, 9, 0.0),
    moneyend: jspb.Message.getFloatingPointFieldWithDefault(msg, 10, 0.0),
    ...
    iscomplete: jspb.Message.getBooleanFieldWithDefault(msg, 16, false),
    ...
    hassubgame: jspb.Message.getBooleanFieldWithDefault(msg, 20, false),
    dtbaseid: jspb.Message.getFieldWithDefault(msg, 21, ""),
    rootgame: jspb.Message.getBooleanFieldWithDefault(msg, 22, false),
...
/**
 * @param {string} value
 * @return {!proto.jarviscrawlercore.DTGPKGameResult} returns this
 */
...
/**
 * @param {!Array<!proto.jarviscrawlercore.DTGPKGameResult>} value
 * @return {!proto.jarviscrawlercore.DTGPKCheckGameResult} returns this
*/
 ...
 * @return {!proto.jarviscrawlercore.ReplyDTData} returns this
*/
...
proto.jarviscrawlercore.ReplyDTData.prototype.clearGamereportsList = function() {
  return this.setGamereportsList([]);
};
...
proto.jarviscrawlercore.ReplyDTData.prototype.clearTodaygamedata = function() {
  return this.setTodaygamedata(undefined);
};
...
proto.jarviscrawlercore.ReplyDTData.prototype.clearCheckgameresultgpk = function() {
  return this.setCheckgameresultgpk(undefined);
};
