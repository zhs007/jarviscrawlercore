 ...
 */
async function execIheima(program, version) {
  program
      .command('iheima [mode]')
      .description('iheima')
      ...
      .action(function(mode, options) {
        ...
        if (!mode) {
          log.console(
              'command wrong, please type ' + 'jarviscrawler iheima --help',
          );
        ...
        (async () => {
          ...
          if (mode == 'news') {
            const ret = await iheimaNews(browser, timeout);
