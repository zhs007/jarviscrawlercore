...
proto.jarviscrawlercore.AlimamaShop.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    servicevolumeList: jspb.Message.getRepeatedFloatingPointField(msg, 10),
    serviceotherList: jspb.Message.getRepeatedFloatingPointField(msg, 11),
    lastupdatedtime: jspb.Message.getFieldWithDefault(msg, 12, 0),
    sellertitleList: jspb.Message.getRepeatedField(msg, 13)
  };
...
proto.jarviscrawlercore.AlimamaShop.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      ...
      msg.setServicevolumeList(value);
      break;
    case 11:
      var value = /** @type {!Array<number>} */ (reader.readPackedFloat());
      msg.setServiceotherList(value);
      break;
    case 12:
...
proto.jarviscrawlercore.ReplyAlimama.prototype.setShop = function(value) {
  jspb.Message.setOneofWrapperField(this, 102, proto.jarviscrawlercore.ReplyAlimama.oneofGroups_[0], value);
};
