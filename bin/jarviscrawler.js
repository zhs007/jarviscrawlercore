...
const {execManhuagui} = require('../src/manhuagui/exec');
const {execTvbsmh} = require('../src/tvbsmh/exec');
...
const {execInvesting} = require('../src/investing/exec');
const fs = require('fs');
...
execManhuagui(program, VERSION);
execTvbsmh(program, VERSION);
